...
export function DayAgendaPopover({ events, title, anchorRect, onExit, }) {
    ...
    return (_jsxs(Popover, { modal: true, open: open, onOpenChange: (next) => {
            ...
            if (!next)
                onExit();
                        ...
                        pointerEvents: 'none',
                    } }) }), _jsxs(PopoverContent, { side: "bottom", align: "start", sideOffset: 8, collisionPadding: { top: 16, right: 16, bottom: 16, left: 16 }, style: {
                    ...popoverContentBase,
                    maxHeight: 'min(85vh, 640px)',
                    overflowY: 'auto',
                    padding: 0,
                    width: 'min(calc(100vw - 1.5rem), 380px)',
                }, children: [_jsx("div", { style: { padding: '12px 16px 8px', borderBottom: '1px solid #edebe9' }, children: _jsx("h3", { style: {
                                margin: 0,
                                fontSize: 16,
                                fontWeight: 600,
                                color: '#242424',
                            }, children: title }) }), _jsx("div", { children: events.map((ev, i) => (_jsx("div", { style: {
